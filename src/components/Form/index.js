...
export default class CustomForm extends React.Component {
  constructor(props) {
    ...
    var formFields = [
      ...
      },
      {
        tag: 'fieldset',
        'cf-questions':
          "Would you be willing to tell us more about yourself? As we prepare to launch, we want to better understand the community we're building together. If you choose to continue, your responses will only be used to help us prioritise our roadmap development and to share updates on the most relevant features.",
        children: [
          {
            tag: 'input',
            type: 'radio',
      ...
      },
      {
        ...
        'cf-questions':
          'Have you ever experienced discrimination or negativity as a Black professional in the industry?',
      ...
      },
      {
        tag: 'fieldset',
        'cf-questions':
          'Have you ever experienced gender-based discrimination or negativity in the industry?',
      ...
      },
      {
        ...
        name: 'pathway',
        'cf-questions':
          'What pathway are you taking/planning to take into tech?',
      ...
      },
      {
        ...
        'cf-questions':
          'Do you feel well-informed about events and resources that are available to you?',
        'cf-conditional-cfc-ethnicity': 'black||mixed-heritage',
        children: [
          {
            tag: 'input',
      ...
      },
      {
        ...
        'cf-questions':
          "Do you have any questions or feedback you'd like to share?",
        //"cf-conditional-cfc-ethnicity": "black||mixed-heritage"
      },
      {
        tag: 'cf-robot-message',
  ...
  endConversationHandler = (event) => {
    ...
    if (evt === 'end') {
      ...
      document.querySelector('#conversational-form').style['pointer-events'] =
        'none';
      clearMemberId();
      setTimeout(() => {
